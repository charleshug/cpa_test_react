...
const QUESTIONBANK = [
  {
    ...
    choices: [{ choice: 'Generally accepted accounting principles in financial reporting by business enterprises.', value: 'false' },
    { choice: 'The meaning of “Present fairly in accordance with generally accepted accounting principles.”', value: 'false' },
    { choice: 'The objectives and concepts for use in developing standards of financial accounting and reporting.', value: 'true' },
    { choice: 'The hierarchy of sources of generally accepted accounting principles.', value: 'false' }
    ],
  ...
  },
  {
    ...
    choices: [{ choice: 'Generally accepted accounting principles.', value: 'false' },
    { choice: 'Reporting for regulators.', value: 'false' },
    { choice: 'The need for conservatism.', value: 'false' },
    { choice: 'The needs of the users of the information.', value: 'true' }
    ],
  ...
  },
  {
    ...
    choices: [{ choice: 'Comparability.', value: 'false' },
    { choice: 'Cost-benefit.', value: 'true' },
    { choice: 'Reliability.', value: 'false' },
    { choice: 'Faithful representation.', value: 'false' }
    ],
  ...
  },
  {
    ...
    choices: [{ choice: 'Relevance, reliability, and faithful representation.', value: 'false' },
    { choice: 'Cost-benefit and materiality.', value: 'false' },
    { choice: 'Comparability, verifiability, timeliness, and understandability.', value: 'true' },
    { choice: 'Completeness, neutrality, and freedom from error.', value: 'false' }
    ],
  ...
  },
  {
    ...
    choices: [{ choice: 'YES | YES', value: 'false' },
    { choice: 'YES | NO', value: 'true' },
    { choice: 'NO | YES', value: 'false' },
    { choice: 'NO | NO', value: 'false' }
    ],
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  root.render(<App question_bank={QUESTIONBANK} />);
});
